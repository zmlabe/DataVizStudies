...
testens1 = np.empty((samples),dtype=int)
testens2 = np.empty((samples),dtype=int)
for i in range(samples):
    rand = np.random.choice(ensembles,size=2,replace=False)
    testens1[i] = rand[0]
    testens2[i] = rand[1]
np.savetxt(directorydata2 + 'EnsembleSelection_DifferProj_ENS-1_%s.txt' % today,testens1)
np.savetxt(directorydata2 + 'EnsembleSelection_DifferProj_ENS-2_%s.txt' % today,testens2)

###############################################################################
###############################################################################
###############################################################################
for i in range(samples):
    var1 = change[testens1[i]]
    var2 = change[testens2[i]]
    count = i+1
    ...
    plt.savefig(directoryfigure + 'GlobalMap3_1991-2020_%s.png' % count,dpi=300)
    ...
    plt.savefig(directoryfigure + 'GlobalMap4_1991-2020_%s.png' % count,dpi=300)
    ...
    plt.savefig(directoryfigure + 'GlobalMap5_1991-2020_%s.png' % count,dpi=300)
