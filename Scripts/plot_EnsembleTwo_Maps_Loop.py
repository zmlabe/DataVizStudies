...
directoryfigure = '/Users/zlabe/Documents/Research/Visualizations/Figures/Loop/%s/' % today
...
for i in range(samples):
    ...
    testens1[i] = rand[0]
    testens2[i] = rand[1]
np.savetxt(directorydata2 + 'EnsembleSelection_ENS-1_%s.txt' % today,testens1)
np.savetxt(directorydata2 + 'EnsembleSelection_ENS-2_%s.txt' % today,testens2)
