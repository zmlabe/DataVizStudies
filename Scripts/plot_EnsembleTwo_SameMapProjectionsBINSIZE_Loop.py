...
directoryfigure = '/Users/zlabe/Documents/Research/Visualizations/Figures/Loop_BinSize/'
...
for i in range(samples):
    var1 = change[int(ens1[i])]
    var2 = change[int(ens2[i])]
    count = i+1
    ...
    limit1 = np.arange(-6,6.01,0.05)
    barlim1 = np.arange(-6,7,2)
    
    limit2 = np.arange(-6,6.01,0.25)
    barlim2 = np.arange(-6,7,2)
    
    limit3 = np.arange(-6,6.01,0.5)
    barlim3 = np.arange(-6,7,2)
    
    limit4 = np.arange(-6,6.01,1)
    barlim4 = np.arange(-6,7,2)
    
    limit5 = np.arange(-6,6.01,2)
    barlim5 = np.arange(-6,7,2)
    ...
    cs = m.contourf(x,y,var,limit1,extend='both')
    ...
    plt.savefig(directoryfigure + 'Bin1_1991-2020_%s.png' % count,dpi=300)
    ...
    cs = m.contourf(x,y,var,limit2,extend='both')
    ...
    plt.savefig(directoryfigure + 'Bin2_1991-2020_%s.png' % count,dpi=300)
    ...
    cs = m.contourf(x,y,var,limit3,extend='both')
    ...
    cbar.set_ticks(barlim3)
    cbar.set_ticklabels(list(map(str,barlim3)))
    cbar.ax.tick_params(axis='x', size=.01,labelsize=5)
    cbar.outline.set_edgecolor('dimgrey')
    ...
    plt.savefig(directoryfigure + 'Bin3_1991-2020_%s.png' % count,dpi=300)
    ...
    cs = m.contourf(x,y,var,limit4,extend='both')
    ...
    cbar.set_ticks(barlim4)
    cbar.set_ticklabels(list(map(str,barlim4)))
    cbar.ax.tick_params(axis='x', size=.01,labelsize=5)
    cbar.outline.set_edgecolor('dimgrey')
    ...
    plt.savefig(directoryfigure + 'Bin4_1991-2020_%s.png' % count,dpi=300)
    ...
    cs = m.contourf(x,y,var,limit5,extend='both')
    ...
    cbar.set_ticks(barlim5)
    cbar.set_ticklabels(list(map(str,barlim5)))
    cbar.ax.tick_params(axis='x', size=.01,labelsize=5)
    cbar.outline.set_edgecolor('dimgrey')
    ...
    plt.savefig(directoryfigure + 'Bin5_1991-2020_%s.png' % count,dpi=300)
