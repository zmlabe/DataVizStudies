...
directoryfigure = '/Users/zlabe/Documents/Research/Visualizations/Figures/Loop_ColorDiverging/'
...
for i in range(samples):
    ...
    plt.savefig(directoryfigure + 'Color1_1991-2020_%s.png' % count,dpi=300)
    ...
    plt.savefig(directoryfigure + 'Color2_1991-2020_%s.png' % count,dpi=300)
    ...
    plt.savefig(directoryfigure + 'Color3_1991-2020_%s.png' % count,dpi=300)
    ...
    plt.savefig(directoryfigure + 'Color4_1991-2020_%s.png' % count,dpi=300)
